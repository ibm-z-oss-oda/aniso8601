...
def parse_timezone(tzstr, builder=PythonTimeBuilder):
    ...
    if tzstr[0] == '+':
        return builder.build_timezone(negative=False, hh=hourstr, mm=minutestr, name=tzstr)
    elif tzstr[0] == '-':
        return builder.build_timezone(negative=True, hh=hourstr, mm=minutestr, name=tzstr)
