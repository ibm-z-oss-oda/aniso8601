...
class TestIntervalParserFunctions(unittest.TestCase):
    def test_parse_interval(self):
        parse = parse_interval('P1M/1981-04-05T01:01:00', builder=NoneBuilder)
        ...
        parse = parse_interval('1980-03-05T01:01:00/1981-04-05', builder=NoneBuilder)
        ...
        parse = parse_interval('1980-03-05/1981-04-05T01:01:00', builder=NoneBuilder)
        ...
        parse = parse_interval('1980-03-05/1981-04-05', builder=NoneBuilder)
        self.assertEqual(parse, (('1980', '03', '05', None, None, None, 'date'), ('1981', '04', '05', None, None, None, 'date'), None, 'interval'))

        parse = parse_interval('1981-04-05/1980-03-05', builder=NoneBuilder)
        self.assertEqual(parse, (('1981', '04', '05', None, None, None, 'date'), ('1980', '03', '05', None, None, None, 'date'), None, 'interval'))

        parse = parse_interval('1980-03-05T01:01:00.0000001/1981-04-05T14:43:59.9999997', builder=NoneBuilder)
        ...
        parse = parse_interval('1980-03-05T01:01:00--1981-04-05T01:01:00', intervaldelimiter='--', builder=NoneBuilder)
        self.assertEqual(parse, ((('1980', '03', '05', None, None, None, 'date'), ('01', '01', '00', None, 'time'), 'datetime'), (('1981', '04', '05', None, None, None, 'date'), ('01', '01', '00', None, 'time'), 'datetime'), None, 'interval'))

        parse = parse_interval('1980-03-05 01:01:00/1981-04-05 01:01:00', datetimedelimiter=' ', builder=NoneBuilder)
        self.assertEqual(parse, ((('1980', '03', '05', None, None, None, 'date'), ('01', '01', '00', None, 'time'), 'datetime'), (('1981', '04', '05', None, None, None, 'date'), ('01', '01', '00', None, 'time'), 'datetime'), None, 'interval'))
...
class TestRepeatingIntervalParserFunctions(unittest.TestCase):
    def test_parse_repeating_interval(self):
        parse = parse_repeating_interval('R3/1981-04-05/P1D', builder=NoneBuilder)
        ...
        parse = parse_repeating_interval('R11/PT1H2M/1980-03-05T01:01:00', builder=NoneBuilder)
        ...
        parse = parse_repeating_interval('R2--1980-03-05T01:01:00--1981-04-05T01:01:00', intervaldelimiter='--', builder=NoneBuilder)
        ...
        parse = parse_repeating_interval('R2/1980-03-05 01:01:00/1981-04-05 01:01:00', datetimedelimiter=' ', builder=NoneBuilder)
        self.assertEqual(parse, (False, '2', ((('1980', '03', '05', None, None, None, 'date'), ('01', '01', '00', None, 'time'), 'datetime'), (('1981', '04', '05', None, None, None, 'date'), ('01', '01', '00', None, 'time'), 'datetime'), None, 'interval'), 'repeatinginterval'))

        parse = parse_repeating_interval('R/PT1H2M/1980-03-05T01:01:00', builder=NoneBuilder)
