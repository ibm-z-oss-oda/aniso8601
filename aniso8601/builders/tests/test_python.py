...
class TestPythonTimeBuilder(unittest.TestCase):
    ...
    def test_build_duration(self):
        testtuples = (({'PnY': '1', 'PnM': '2', 'PnD': '3',
                      ...
                      ({'PnY': '1999.99999999999997'}, datetime.timedelta(days=729999, seconds=86399, microseconds=999999)),
    ...
    def test_build_interval(self):
        testtuples = (({'end': (('1981', '04', '05', None, None, None, 'date'),
                      ...
                      #https://bitbucket.org/nielsenb/aniso8601/issues/10/sub-microsecond-precision-in-durations-is
                      #https://bitbucket.org/nielsenb/aniso8601/issues/21/sub-microsecond-precision-is-lost-when
                      ({'start': ('0001', '01', '01', None, None, None, 'date'),
                        'duration': ('1999.99999999999997', None, None,
                                     None, None, None,
                                     None, 'duration')},
                      ...
                      ({'start': ('1989', '03', '01', None, None, None, 'date'),
                        'duration': (None, '1.99999999999997', None,
                                     None, None, None,
                                     None, 'duration')},
                       ...
                       datetime.datetime(year=1989, month=4, day=29,
                                         ...
                                         microsecond=999999)),
                      ({'start': ('1989', '03', '01', None, None, None, 'date'),
                        'duration': (None, None, '1.9999999999997',
                                     None, None, None,
                                     None, 'duration')},
                       datetime.date(year=1989, month=3, day=1),
